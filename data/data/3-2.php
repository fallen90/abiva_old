	...
	$array = [
				...
				"tutorial" => [
								[
									...
									"content" => "<div style='list-style-type: square;'><span><div>There are four kinds of sentences:</div> <ul> <li>declarative sentence</li><li>interrogative sentence</li><li>imperative sentence</li> <li>exclamatory</li> </ul>  </span></div></p>",

								],
								[
									"title"   => "Information Question",
									"lesson_type" => "side_tabs",
									"content" => " space_in <div style='list-style-type: square;'><span><div><div>An <i style='color:#220158178'>information questions</i> requires information for an answer. It can begin with what, who, when, where, why and how.</div><br>It is sometimes called a 'wh-question.'</div> <div>Example :</div><ul> <li>Who are you?</li> <li>Where do you live?</li>  </ul>  </span></div> space_out "
								],
								[
									"title"   => "Yes/No",
									"lesson_type" => "side_tabs",
				...
				"activity" => [
								[
									...
									"questions" => [
											...
											[
												"question_text" => "One Sunday morning, the Reyes family was getting ready for an outing.",
												"question_type" => "multiple_choice_dual",
												"question_choices" => ["Interrogative","Declarative","Exclamatory","Imperative"],
												"question_choices_2" => ["!",".","?"],
												"question_answer"=>"Declarative"
											...
											[
												"question_text" => "Look under the sofa.",
												"question_type" => "multiple_choice_dual",
												"question_choices" => ["Interrogative","Declarative","Exclamatory","Imperative"],
												"question_choices_2" => ["!",".","?"],
												"question_answer"=>"Imperative"
											...
											[
												"question_text" => "Where is the car key?",
												"question_type" => "multiple_choice_dual_dual",
												"question_choices" => ["Interrogative","Declarative","Exclamatory","Imperative"],
												"question_choices_2" => ["!",".","?"],
												"question_answer"=>"Interrogative"
											],
											[
												"question_text" => "Please look for it.",
												"question_type" => "multiple_choice_dual",
												"question_choices" => ["Interrogative","Declarative","Exclamatory","Imperative"],
												"question_choices_2" => ["!",".","?"],
												"question_answer"=>"Imperative"
											...
											[
												"question_text" => "Who has seen the car key?",
												"question_type" => "multiple_choice_dual",
												"question_choices" => ["Interrogative","Declarative","Exclamatory","Imperative"],
												"question_choices_2" => ["!",".","?"],
												"question_answer"=>"Interrogative"
								...
								[
									...
									"questions" => [
											...
											[
												"question_text" => "Where are you going today?",
												"question_type" => "multiple_choice",
												"question_choices" => ["Yes/No","Information"],
												"question_answer"=>"Information"
											],
											[
												"question_text" => "What books do you borrow from the library?",
												"question_type" => "multiple_choice",
												"question_choices" => ["Yes/No","Information"],
												"question_answer"=>"Information"
											],
											[
												"question_text" => "Do you actively participate in classroom activities?",
												"question_type" => "multiple_choice",
												"question_choices" => ["Yes/No","Information"],
												"question_answer"=>"Yes/No"
											],
											[
												"question_text" => "How do you apply for a library card?",
												"question_type" => "multiple_choice",
												"question_choices" => ["Yes/No","Information"],
												"question_answer"=>"Information"
											],
											[
												"question_text" => "Who inspires you to study very well?",
												"question_type" => "multiple_choice",
												"question_choices" => ["Yes/No","Information"],
												"question_answer"=>"Information"
											],
