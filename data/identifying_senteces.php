<?php
	$array = [
				[
					...
					"instruction"=> "Tell  whether each group of words is a sentence or a phrase.",
					...
					"questions" => [
							[
								...
								"question_choice" => ["Phrases","Sentences"],
								"question_answer"=>"Sentences"
							],
							[
