<?php
	$array = [
				[
					...
					"instruction"=> "Match each phrases to make a sentence.",
					...
					"questions" => [
							...
							[
								...
								"question_answer"=>"watching the city's Panagbenga Festival."
							],
							[
								"question_text" => "My sister and I joined",
								"question_type" => "matching",
								"question_choice" =>"watching the city's Panagbenga Festival.",
